...
parser.add_argument('-nsd', default=False, type=bool, help='set it to False to disable NSD computation and save time')
...
def compute_metrics(npz_name):
    ...
    print(f"{npz_name} dsc value: %f" %dsc)
    ...
    print(f"{npz_name} nsd value: %f" %nsd)
