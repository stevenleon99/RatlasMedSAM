...
parser.add_argument("-num_train", type=int, default=40, help="number of cases used for train, the rest will be used for test")
...
if __name__ == "__main__":
    tr_names = names[:args.num_train] # training
    ts_names = names[args.num_train:] # testing
